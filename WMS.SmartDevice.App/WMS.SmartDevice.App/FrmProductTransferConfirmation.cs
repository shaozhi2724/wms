...
{
    public partial class FrmProductTransferConfirmation : Form
    {
        public TransferProductViewModel SourceTransferProduct { get; set; }
        public FrmProductTransferConfirmation()
        {
            InitializeComponent();
        }
        ...
        {
            FrmProductTransferSource.Instance().Show();
            Close();
        }

        // Singleton design patern
        private static FrmProductTransferConfirmation _Instance = null;
        public static FrmProductTransferConfirmation Instance()
        {
            if (_Instance == null || _Instance.IsDisposed)
            {
                _Instance = new FrmProductTransferConfirmation();
            }
                ...
                try
                {
                    using (SqlConnection conn = new SqlConnection(Program.ConnectionString))
                    {
                        ...
                        conn.Execute(query, new {
                            ...
                            TargetBarcode = targetStructureCode },null);
